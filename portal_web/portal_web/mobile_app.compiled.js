...
function MobileApp() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "w-10 h-10 sm:w-11 sm:h-11 rounded-2xl bg-gradient-to-br from-amber-400 via-amber-500 to-amber-700 p-0.5 shadow-lg flex items-center justify-center"
  }, /*#__PURE__*/React.createElement("img", {
